    ...
    function Blog() {
        return (
            <div className='w-[1920px] h-[5019px]'>
                ...
                <div className="w-[1920px] h-[410px]">
                    ...
                    <div className='w-[225px] h-[104px] z-100'>
                        ...
                        <div className='w-[133px] h-7 flex items-center absolute top-[274px] left-[897px]'>
                            ...
                            <Link href='/blog' className='text-[#ff9f0d] text-[20px] font-normal leading-7'>Blog</Link>
                        </div>
                ...
                <div className="flex flex-col items-start text-base max-w-[872px] min-h-[830px] absolute top-[550px] left-[300px]" >
                    <div
                    ...
                    >
                        ...
                        />
                        <div
                            className="relative px-4 pt-3 mb-0 bg-amber-500 rounded-md h-[60px] w-[60px] max-md:mb-2.5"
                ...
                {/* Navigator */}
                <div className="max-w-[306px] min-h-[51px] flex gap-3.5 items-start absolute top-[4074px] left-[583px]" aria-label="Progress Steps">
                    <div
                ...
                <div className="flex flex-col mx-auto w-full max-w-[424px] min-h-[2501px] absolute top-[530px] left-[1196px]">
                    <form className="flex gap-5 justify-between pr-px pl-5 max-w-full text-base border border-solid border-neutral-200 stroke-neutral-200 text-stone-300 w-[422px]">
                        <label className="sr-only">Search Your Keyword</label>
                        <input
                            type="search"
                            id="searchInput"
                            className="my-auto w-full bg-transparent border-none focus:outline-none"
                            placeholder="Search Your Keyword.."
                            aria-label="Search Your Keyword"
                        />
                        <button type="submit" className="flex items-center justify-center w-[76px]" aria-label="Search">
                            <Search className="object-contain shrink-0 aspect-[1.09] fill-amber-500 stroke-[1px] stroke-amber-500 w-[76px]" />
                        </button>
                    </form>
