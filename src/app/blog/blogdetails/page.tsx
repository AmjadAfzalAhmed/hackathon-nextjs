...
function blogDetails() {
    return (
        <div className='w-[1920px] h-[2811px]'>
            {/* Header */}
            <div className="max-w-[1920px] min-h-[90px]  flex items-center bg-stone-950 " >
                <div className="w-[1320px] h-8 absolute top-[29px] left-[300px] flex flex-wrap gap-10 sm:justify-center items-center">
            ...
            <div className="w-[1920px] h-[410px]">
                ...
                <div className='w-[225px] h-[104px] z-100'>
                    ...
                    <div className='w-[133px] h-7 flex items-center absolute top-[274px] left-[897px]'>
                        ...
                        <Link href='/blog/blog-details' className='text-[#ff9f0d] text-[20px] font-normal leading-7'>BlogDetails</Link>
                    </div>
